...
var PIXEL_DIGIT_GLYPHS = {
  ...
  'G': ['.1111.', '11..11', '11....', '11....', '11.111', '11..11', '11..11', '11..11', '.1111.'],
  'H': ['11..11', '11..11', '11..11', '111111', '111111', '11..11', '11..11', '11..11', '11..11'],
  'I': ['111111', '..11..', '..11..', '..11..', '..11..', '..11..', '..11..', '..11..', '111111'],
  'J': ['....11', '....11', '....11', '....11', '....11', '....11', '11..11', '11..11', '.1111.'],
  'K': ['11...1', '11..1.', '11.1..', '111...', '1111..', '11.1..', '11..1.', '11...1', '11...1'],
  'L': ['11....', '11....', '11....', '11....', '11....', '11....', '11....', '11....', '111111'],
  'M': ['11..11', '111111', '111111', '111111', '11..11', '11..11', '11..11', '11..11', '11..11'],
  ...
  'Q': ['.1111.', '11..11', '11..11', '11..11', '11..11', '11.11.', '11..1.', '.111..', '..111.'],
...
function buildPixelDigitCells(ch, paletteName, outlineColor, rampOffset) {
  var rows = PIXEL_DIGIT_GLYPHS[ch] || PIXEL_DIGIT_GLYPHS[String(ch).toUpperCase()];
  if (!rows) { return []; }
